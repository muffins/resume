...
\cvhonor
{AMTSO 2025} % Event
{Joker hates this one weird trick! - Taking down Joker Toll Fraud campaigns using server misconfigurations} % Role
...
\cvhonor
{0x0G} % Event
{Emerging Malware Threats in the Off-Market Space} % Role
...
%\small \center \textit{For a full list of my public presentations, see my site at brewfault.com/talks}

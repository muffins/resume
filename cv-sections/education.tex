...
% Masters Degree
\cventry
{Master of Science in Cybersecurity, 3.889 GPA} % Degree
...
% Masters Degree
\cventry
{Master of Science in Mathematics, \textbf{Did Not Complete}, 3.42 GPA} % Degree
...
% Bachelors Degree
\cventry
{Bachelor of Science in Mathematics, Minor in Computer Science, 3.883 GPA} % Degree
{University of Wyoming} % Institution
{Laramie, WY} % Location
